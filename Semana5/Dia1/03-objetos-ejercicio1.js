...
///EJERCICIO 2
/////ejercicio que devuelve el nombre de la pelicula con mayor popularidad

function mayorPopular() {
    let masPopular = 0
    let posPEl = -1
    for (let i = 0; i < peliculas.length; i++) {
        if (peliculas[i].popularity > masPopular) {
            masPopular = peliculas[i].popularity
            posPEl = i
        }
    }
    return peliculas[posPEl].title
}

console.log('mas popular', mayorPopular());

console.log('//////////////////////////////////')
///EJERCICIO 3
////funcion que retorna el nombre de la pelicula con mas generos
...
function masGeneros() {
    ...
    let pelmasgen = []
    for (let i = 0; i < peliculas.length; i++) {
        if (peliculas[i].genre_ids.length > Genero) {
            Genero = peliculas[i].genre_ids.length
            mGen = i
        }
    }
    for (let e = 0; e < peliculas.length; e++) {
        if (peliculas[e].genre_ids.length === mGen) {
            pelmasgen.push(peliculas[e].title)
        }
    }
    return pelmasgen
}

console.log(masGeneros());
console.log('//////////////////////////////////')


/////EJERCICIO 4

function primerapeli() {
    // debugger
    let listaGeneros = []
    genDePelis = peliculas[0].genre_ids
    for (let i = 0; i < genDePelis.length; i++) {
        for (let e = 0; e < genero.length; e++) {
            if (peliculas[0].genre_ids[i] === genero[e].id) {
                listaGeneros.push(genero[e].name)
            }
        }
    }
return listaGeneros
}
console.log(primerapeli());